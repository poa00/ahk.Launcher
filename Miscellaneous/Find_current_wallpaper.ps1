# Source: https://confidentialfiles.wordpress.com/2013/12/09/finding-wallpaper-location-in-windows-7-and-windows-8/
Try
{
  # Get script name
  ...
  # Open this photo in the default application
  & "$WallpaperSource"
...
#  $result=[System.Windows.Forms.MessageBox]::Show("Wallpaper location: `r$WallpaperSource`r`rLaunch Explorer?", "Find Current Wallpaper", "YesNo");
#  if ($result -eq "Yes")
#  {
